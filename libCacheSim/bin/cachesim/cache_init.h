...
static inline cache_t *create_cache(const char *trace_path,
  ...
  static const eviction_algo_entry_t simple_algos[] = {
      ...
      {"s4fifo", S4FIFO_init},
      {"s4fifov2", S4FIFOv2_init},
      {"s4fifov3", S4FIFOv3_init},
      {"s4fifov4", S4FIFOv4_init},
      {"s4fifov5", S4FIFOv5_init},
      {"s4fifov6", S4FIFOv6_init},
      {"s4fifov7", S4FIFOv7_init},
      {"s4fifov8", S4FIFOv8_init},
      {"s4fifovclear", S4FIFOvclear_init},
      {"sieve", Sieve_init},
      {"size", Size_init},
      {"slru", SLRU_init},
      {"slruv0", SLRUv0_init},
